!!****if* source/Grid/GridSolvers/HYPRE_KPD/paramesh/gr_hypreGridStatus
!!
!!  NAME 
!!
!!  gr_hypreGridStatus
...
if (gr_meshMe .eq. 0) print*,"gr_hypreGridStatus B1",grid_changed

     if (grid_changed == 1) then
        
        call Driver_getNStep(NStep)
if (gr_meshMe .eq. 0) print*,"gr_hypreGridStatus B2",NStep,gr_hypreNStep
