!!****if* source/Grid/GridSolvers/Multipole_new/gr_mpolePot3Dcylindrical
!!
!! NAME
!!
...
!
!
     alpha     = TWO * DeltaKFourthSine * DeltaKFourthSine      ! for calculating sin (phi + n * DeltaKHalf)
     beta      = DeltaKHalfSine                                 ! and cos (phi + n * DeltaKHalf)
     ...
     do kF = 0, kFmax                                           ! loop over local k face indices
      ...
      z = bndBoxJLow + jB * DeltaJHalf - gr_mpoleZcenter        ! initial z-axis location of j face
      ...
      do jF = jB, jFmax, jS                                     ! loop over local j face indices
       ...
       Rcyl = bndBoxILow + iB * DeltaIHalf                      ! initial Rcyl-axis location of i face
...
!
       ...
       z = z + jS * DeltaJHalf       ! face position increment along z-axis
      end do

      phiSineSave = phiSine                                                  !
      phiSine     = phiSine   - (alpha * phiSine   - beta * phiCosine  )     ! face increment angular axis
