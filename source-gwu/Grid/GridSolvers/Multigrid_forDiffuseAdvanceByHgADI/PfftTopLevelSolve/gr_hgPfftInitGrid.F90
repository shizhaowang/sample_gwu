!!****if* source/Grid/GridSolvers/Multigrid_forDiffuseAdvanceByHgADI/PfftTopLevelSolve/gr_hgPfftInitGrid
!!
!! NAME
!!
!!  gr_hgPfftInitGrid
...
#include "Pfft.h"
  ...
  if ( (gr_hgPfftLastMappedLevel == refinementLevel) .and. &
     ...
     transformType(IAXIS:KAXIS)=PFFT_TRANSFORM_NONE
     baseDatType = (/ (MDIM+1)* PFFT_PCLDATA_REAL /)
     needMap=.true.
