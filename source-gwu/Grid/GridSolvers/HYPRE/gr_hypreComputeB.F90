...
!!   Uses HYPRE library.
!!
!!   When using Grid_advanceDiffusion to advance a generalized diffusion problem:
!!
!!   gr_hypreVecX is assumed to represent the value of the solution variable iVar from the
!!   previous time step.
!!
