...
!               Poisson's Equation using Adaptive Mesh Refinement," 1996).
  ...
  subroutine gr_mgCycleSUPERLU (levelmax, levelmin, img_soln, img_src, & 
...
!      call mg_relax_RBGS   (mgrid_solveLevelKPD, img_res, img_corr,1000,img_denx,mgrid_solveLevelKPD)
      ...
      call mg_relax_SUPERLU  (img_corr, img_res,1.0)
      call cpu_time(t_stop)
      if (gr_meshMe .eq. 0) print*,"SUPERLU All Solver Time         ",t_stop-t_start
