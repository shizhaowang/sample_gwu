...
subroutine poisson_mg_residualMG (level, irhs, ilhs, ires, leaf_only, & 
                             flux_cons, idenvar, levelmax)
...
#include "mpif.h"
  ...
  integer :: level, irhs, ilhs, ires, leaf_only, flux_cons, idenvar, levelmax
              ...
              do j = jli-1, jui
                 do i = ili-1, iui
                    ...
                    if (MdensXR.lt.1. .OR. MdensYR.lt.1. ) then
                       print*,"ERROR 0 poisson_mg_residualMG.F90: Density Equals Zero at a FACE",lb,i,j,MdensXR,MdensYR,idenvar
              ...
              do k = kli-1, kui
                 do j = jli-1, jui
                    do i = ili-1, iui
                       ...
                       if (MdensXR.lt.0. .OR. MdensYR.lt.1. .OR. MdensZR.lt.1.) then
                          print*,"ERROR 1 poisson_mg_residualMG.F90: Density Equals Zero at a FACE",lb,i,j,MdensXR,MdensYR,idenvar
...
!if (gr_meshMe .eq. 0) print*,"Checkpoint C"
     ...
     elseif (ndim == 2) then
        ...
        do lb = 1, lnblocks2
           ...
           !- kpd - This only updates 3,25,47,69 (ONLY leaf blocks at lower level)
           if (update_values(lb)) then

              !print*,"poisson_mg_residualMG.F90 Value Update Blocks:",gr_meshMe,level,lb
              ...
              !print*,"mg_residualMG",lb,unkt(ires,5,5,1),unkt(ires,10,10,1)
...
!  call timer_stop("residual")
  ...
  return
end subroutine poisson_mg_residualMG
