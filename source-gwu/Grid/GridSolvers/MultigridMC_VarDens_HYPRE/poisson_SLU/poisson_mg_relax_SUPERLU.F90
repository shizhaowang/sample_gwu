...
!subroutine poisson_mg_relax_SUPERLU (isoln, isrc, bc_types, bc_values, poisfact)
subroutine poisson_mg_relax_SUPERLU (isoln, isrc, poisfact)
...
!  if (firstcall .or. gr_sluGridChanged) then !!! If first time or grid changed
     ...
     !call set_superlu_options(options,ColPerm=MMD_ATA)
     !call set_superlu_options(options,RowPerm=NATURAL)
     !call set_superlu_options(options,IterRefine=NATURAL)
     !call set_superlu_options(options,num_lookaheads=10)
...
!===============================================================================
!===============================================================================
!  KPD - This needed to be added or else segfault on 2nd V-cycle...
!===============================================================================
!===============================================================================
...
200   call f_superlu_gridexit(grid)
...
end subroutine poisson_mg_relax_SUPERLU
