!!****if* source/Grid/GridSolvers/MultigridMC_VarDens_HYPRE/gr_mgMapBcType
!!
!! NAME
!!  gr_mgMapBcType
!!
...
!KPD     case(OUTFLOW,DIODE,REFLECTING,DIRICHLET,SLIP_INS,NOSLIP_INS,MOVLID_INS)
...
!!$                    else
                       ...
                       !write(*,*) 'In Outflow... gr_hgMapBcType'
...
!              call Driver_abortFlash("gr_mgMapBcType: Unexpected boundary condition requested for WORK array!")
     ...
     case default
           print*,"KPD Error: need to add NEUMANN_INS to gr_mgMapBcType.F90"
           if (gr_meshMe .EQ. MASTER_PE) print*, &
