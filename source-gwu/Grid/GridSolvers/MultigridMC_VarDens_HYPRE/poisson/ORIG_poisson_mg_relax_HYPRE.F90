!!****if* source/Grid/GridSolvers/MultigridMC_VarDens_HYPRE/poisson/ORIG_poisson_mg_relax_HYPRE
!!
!! NAME
!!
!!  Grid_solvePoisson
...
subroutine poisson_mg_relax_HYPRE (level,iSrc, iSoln, idenvar, levelmax)
...
#include "constants.h"
  ...
  integer, intent(in)     :: iSoln, iSrc, level, levelmax, idenvar
  ...
  !!- kpd - I added this as a means of caution for now...
     ...
     do k = blkLimits(LOW, KAXIS), blkLimits(HIGH, KAXIS)      
        do j = blkLimits(LOW, JAXIS), blkLimits(HIGH, JAXIS)
           do i = blkLimits(LOW, IAXIS), blkLimits(HIGH, IAXIS)
              ...
              print*,"Bvec",blockID,i,j,ii,solnVec(iSrc,i,j,k),unk(iSrc,i,j,k)
