...
!                    end if
                    ...
                    if (MdensXR.lt.0. .OR. MdensYR.lt.0. ) then
...
!                       end if
                       ...
                       if (MdensXR.lt.0. .OR. MdensYR.lt.0. .OR. MdensZR.lt.0.) then
                          if (dr_nstep .gt. 1) then
     ...
     elseif (ndim == 2) then
        ...
        do lb = 1, lnblocks2
           ...
           if (update_values(lb)) then
              ...
              !print*,"poisson_mg_residualMG.F90 Calculate the Residual Blocks:",gr_meshMe,level,lb
