...
!               Poisson's Equation using Adaptive Mesh Refinement," 1996).
  ...
  subroutine gr_mgCycleHYPRE_PC (levelmax, levelmin, img_soln, img_src, & 
...
!-------------------------------------------------------------------------------
      ...
      if (gr_meshMe .eq. 0) print*,"Using RBGS at bottom of multigrid with steps = 10"
      !call mg_relax_RBGS   (SolveLevelKPD, img_res, img_corr,5500,img_denx,SolveLevelKPD)
      call mg_relax_RBGS   (mgrid_solveLevelKPD, img_res, img_corr,10,img_denx,mgrid_solveLevelKPD)
