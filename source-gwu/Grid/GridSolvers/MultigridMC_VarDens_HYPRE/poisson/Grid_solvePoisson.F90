...
external poisson_mg_solve, poisson_mg_residual, poisson_mg_residualMG, &
         poisson_mg_relax_RBGS, poisson_mg_relax_ZEBRA, poisson_mg_relax_RBGSMG, &
...
!-------------------------------------------------------------------------------
   ...
   !--------------------------------------------------------------
    ...
    if (gr_meshMe .eq. 0)  print*,"Using ZEBRA RELAXATION"
    ...
    call multigridHYPRE (isrc, isoln, poisfact, imgw1, imgw2, imgw3, imgw4, imgw5, &
                    ...
                    poisson_mg_relax_ZEBRA, & !poisson_mg_relax_RBGS, &
