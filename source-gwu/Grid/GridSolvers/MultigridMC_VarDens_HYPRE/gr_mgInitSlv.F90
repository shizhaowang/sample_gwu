...
if (gr_meshMe .eq. 0) print*,"Did the Grid Change in gr_mgInitSlv?",grid_changed
...
call mpi_allreduce ( lmax, mesh_lrefmax, 1, MPI_INTEGER, MPI_MAX, & 
                     MPI_COMM_WORLD, ierr )
! Shizhao, debug
!write(*,*) 'proc, mesh_lrefmin, local:', gr_meshMe, mesh_lrefmin, lmin
!write(*,*) 'proc, mesh_lrefman, local:', gr_meshMe, mesh_lrefmax, lmax
