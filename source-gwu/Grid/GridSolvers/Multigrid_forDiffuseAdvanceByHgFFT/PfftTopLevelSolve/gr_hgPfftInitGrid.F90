!!****if* source/Grid/GridSolvers/Multigrid_forDiffuseAdvanceByHgFFT/PfftTopLevelSolve/gr_hgPfftInitGrid
!!
!! NAME
!!
!!  gr_hgPfftInitGrid
...
subroutine gr_hgPfftInitGrid(refinementLevel, gridChanged, poisfact)
  ...
  use gr_hgPfftData, ONLY : gr_hgPfftInArray, gr_hgPfftOutArray, &
       ...
       gr_hgPfftLastMappedLevel, gr_hgPfftBcTypes
...
#include "Pfft.h"
  ...
  if ( (gr_hgPfftLastMappedLevel == refinementLevel) .and. &
     ...
     call gr_pfftSpecifyTransform(transformType, baseDatType, gr_hgPfftBcTypes) !gr_hgPfftBcTypes initialized in gr_hgPfftInit
