!!****if* source/Grid/GridSolvers/Multigrid_forDiffuseAdvanceByHgFFT/gr_hgSolve
!!
!! NAME
!!  gr_hgSolve
!!
...
#include "Multigrid.h"
  ...
  do m = 1, gr_hgMeshRefineMax
     ...
     call gr_hgSolveLevel(m, gr_iSource, gr_iSoln, SolveBlock, MG_NODES_ALL_NODES, dt, chi)
  ...
  do n = 0, gr_hgMaxCorrections
     ...
     do m = 2, gr_hgMeshRefineMax
        ...
        call gr_hgSolveLevel(m, gr_iSls, gr_iCorr, SolveBlock, MG_NODES_ALL_NODES, dt, chi)
