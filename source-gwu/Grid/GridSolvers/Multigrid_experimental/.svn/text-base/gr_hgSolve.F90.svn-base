!!****if* source/Grid/GridSolvers/Multigrid_experimental/gr_hgSolve
!!
!! NAME
!!  gr_hgSolve
!!
...
#include "Multigrid.h"
  ...
  enddo
  call gr_hgResidual(0, gr_iSource, gr_iSoln, gr_iSls) !oK
  ...
  do n = 0, gr_hgMaxCorrections
     ...
     enddo
     call gr_hgResidual(0, gr_iSls, gr_iCorr, gr_iSls)  ! not called on top level
