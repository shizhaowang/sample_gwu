!!****if* source/Grid/GridSolvers/Multigrid_experimental/amr_get_new_nodetypes
!!
!! NAME
...
!! NOTES
!!
!! DEV: IT SEEMS HAVING THIS SEPARATE INSTANCE OF THIS SUBROUTINE IS NOT NECESSARY. KW
!!
