!!****if* source/Grid/GridSolvers/HYPRE_KPDa/Grid_solvePoisson
!!
!! NAME
!!
!!  Grid_solvePoisson
...
!KPD  use gr_mgInterface, ONLY : mg_restore_nodetypes
...
!!$    character(len=32) :: matfile
  ...
  !   call mg_restore_nodetypes (mylevel)
  !end do
     ...
     do k = blkLimits(LOW, KAXIS), blkLimits(HIGH, KAXIS)      
        do j = blkLimits(LOW, JAXIS), blkLimits(HIGH, JAXIS)
           do i = blkLimits(LOW, IAXIS), blkLimits(HIGH, IAXIS)
              ...
              !print*,blockID,ii,cellVolumes(i,j,k),solnVec(iSrc,i,j,k),RHSVal(ii) 
