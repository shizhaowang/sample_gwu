...
! Main Interpolation loop.
      ...
      if (iedge_dir == 2) then ! interpolate unk_e_y
...
! Interpolate in z direction
     ...
     &                 weight_half(kw,kpar-k,order)*f_inty(i,j,kpar)
      ...
      elseif (iedge_dir == 1) then ! interpolate unk_e_x
...
! Interpolate in z direction
     ...
     &                 weight_half(kw,kpar-k,order)*f_intx(i,j,kpar)
      ...
      elseif (iedge_dir == 3) then ! interpolate facevarz
