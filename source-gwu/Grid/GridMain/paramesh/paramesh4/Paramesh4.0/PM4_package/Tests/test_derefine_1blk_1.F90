...
! application specific variables
      ...
      integer ierror_sum,ierror_tot, totblocks
...
! Loop_count=3 does derefinement step.
        do while(loop_count.lt.4)
...
!     .       coord(3,l).eq..375) refine(l)=.true.
...
#ifdef TEST1
              if(coord(1,l).lt..120.and.coord(2,l).lt..120 & 
     &           .and.coord(3,l).lt..120) & 
     &                 derefine(l)=.true.
              if(coord(1,l).gt..255.and.coord(1,l).lt..495.and. & 
     &           coord(2,l).gt..255.and.coord(2,l).lt..495.and. & 
     &           coord(3,l).gt..255.and.coord(3,l).lt..495) & 
     &                 derefine(l)=.true.
              if(coord(1,l).gt..505.and.coord(1,l).lt..995.and. & 
     &           coord(2,l).gt..005.and.coord(2,l).lt..495.and. & 
     &           coord(3,l).gt..005.and.coord(3,l).lt..495) & 
     &                 derefine(l)=.true.
              if(coord(1,l).gt..005.and.coord(1,l).lt..245.and. & 
     &           coord(2,l).gt..755.and.coord(2,l).lt..995.and. & 
     &           coord(3,l).gt..755.and.coord(3,l).lt..995) & 
     &                 derefine(l)=.true.
              if(coord(1,l).gt..505.and.coord(1,l).lt..620.and. & 
     &           coord(2,l).gt..755.and.coord(2,l).lt..870.and. & 
     &           coord(3,l).gt..755.and.coord(3,l).lt..870) & 
     &                 derefine(l)=.true.
#endif /* TEST1 */
#ifdef TEST2
              if(coord(1,l).gt..005.and.coord(1,l).lt..245.and. & 
     &           coord(2,l).gt..005.and.coord(2,l).lt..245.and. & 
     &           coord(3,l).gt..005.and.coord(3,l).lt..245) & 
     &                 derefine(l)=.true.
              if(coord(1,l).gt..255.and.coord(1,l).lt..370.and. & 
     &           coord(2,l).gt..255.and.coord(2,l).lt..370.and. & 
     &           coord(3,l).gt..255.and.coord(3,l).lt..370) & 
     &                 derefine(l)=.true.
              if(coord(1,l).gt..505.and.coord(1,l).lt..995.and. & 
     &           coord(2,l).gt..005.and.coord(2,l).lt..495.and. & 
     &           coord(3,l).gt..005.and.coord(3,l).lt..495) & 
     ...
     &                 derefine(l)=.true.
              if(coord(1,l).gt..255.and.coord(1,l).lt..495.and. & 
     &           coord(2,l).gt..255.and.coord(2,l).lt..495) & 
     &                 derefine(l)=.true.
              if(coord(1,l).gt..505.and.coord(1,l).lt..995.and. & 
     &           coord(2,l).gt..005.and.coord(2,l).lt..495) & 
     &                 derefine(l)=.true.
              if(coord(1,l).gt..005.and.coord(1,l).lt..245.and. & 
     &           coord(2,l).gt..755.and.coord(2,l).lt..995) & 
     &                 derefine(l)=.true.
              if(coord(1,l).gt..505.and.coord(1,l).lt..620.and. & 
     &           coord(2,l).gt..755.and.coord(2,l).lt..870) & 
     &                 derefine(l)=.true.
#endif /* TEST1 */
#ifdef TEST2
              if(coord(1,l).gt..005.and.coord(1,l).lt..245.and. & 
     &           coord(2,l).gt..005.and.coord(2,l).lt..245) & 
     &                 derefine(l)=.true.
              if(coord(1,l).gt..255.and.coord(1,l).lt..370.and. & 
     &           coord(2,l).gt..255.and.coord(2,l).lt..370) & 
     &                 derefine(l)=.true.
              if(coord(1,l).gt..505.and.coord(1,l).lt..995.and. & 
     &           coord(2,l).gt..005.and.coord(2,l).lt..495) & 
     &                 derefine(l)=.true.
     ...
     &                 derefine(l)=.true.
      ...
      endif                    ! end of loop_count if test

#else /*  STANDARD_TESTS */

#ifdef LOU_2D_PATTERN
      if(loop_count.eq.0) then
       refine(:) = .true.
      elseif(loop_count.eq.1) then
       refine(:) = .false.
       do l=1,lnblocks
         if( coord(1,l).gt..5) refine(l)=.true.
       enddo
      elseif(loop_count.eq.2) then
       refine(:) = .false.
       do l=1,lnblocks
         if( coord(1,l).gt..75  .and. & 
     &      (coord(2,l).gt..25 .and. coord(2,l).lt..75) & 
     &              ) refine(l)=.true.
       enddo
      endif
...
! refine grid and apply morton reordering to grid blocks if necessary
     ...
     &    ' loop_count = ',loop_count
      ...
      do l=1,lnblocks
      write(*,*) 'blk = ',l,' derefine ',derefine(l)
      enddo
...
! end temporary testing section
      ...
      call comm_int_sum_to_all(totblocks,lnblocks)
#ifdef TEST1
      if(ndim.eq.3) then
      elseif(ndim.eq.2) then
        if(totblocks.ne.25) then
        if(mype.eq.0) then
          write(*,*)  & 
     &     'ERROR: wrong number of total blocks after derefinement', & 
     &     ' found ',totblocks,' should have 25.'
      ...
      if(ndim.eq.3) then
      elseif(ndim.eq.2) then
        if(totblocks.ne.29) then
        if(mype.eq.0) then
          write(*,*) & 
     &     'ERROR: wrong number of total blocks after derefinement', & 
     &     ' found ',totblocks,' should have 29.'
          ierror_sum = ierror_sum + 1
        endif
        endif
      endif
...
! Sum number of errors 
     ...
     &                'Test of derefine_1blk_1 Successful ', & 
     ...
     &                'Test of derefine_1blk_1 failed ', & 
     &                ': nprocs ',nprocs,' ndim ',ndim, & 
     &                ' noperm ',lnperm,' advanceall ',ladvanceall, & 
     &                ' mpi ',lmpi
        endif
...
990      format('ex:error proc ',i3,' block l= ',5(2x,i3),2x,f7.4,2x, & 
     &       f7.4)
      ...
      end program test_derefine_1blk_1
