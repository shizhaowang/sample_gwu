...
#include "paramesh_preprocessor.fh"
      ...
      program test_checkpoint1


! This test differs from test_checkpoint only in the setting for
! l_with_guardcells which is only meaningful if NO_PERMANENT_GUARDCELLS
! is undefined.
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     ...
     &                'Test of checkpoint1 Successful ', & 
