...
! reset interpolation order(s)
      ...
      interp_mask_facex_res(:) = 2
      interp_mask_facey_res(:) = 2
      interp_mask_facez_res(:) = 2
      interp_mask_ec_res(:) = 2
      interp_mask_nc_res(:) = 2
...
! Sum number of errors 
     ...
     &                'Test of c_to_f_1blk_2 Successful ', & 
