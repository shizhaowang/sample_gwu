...
!!!
      ...
      if (.not.allocated(to_be_levels)) then 
          allocate(to_be_levels(1:lrefine_max))
          do i = 1,lrefine_max
            nullify(to_be_levels(i) % to_be_sent_guard_mg)
            nullify(to_be_levels(i) % to_be_sent_prol_mg)
            nullify(to_be_levels(i) % to_be_sent_flux_mg)
            nullify(to_be_levels(i) % to_be_sent_restrict_mg)
            nullify(to_be_levels(i) % to_be_received_guard_mg)
            nullify(to_be_levels(i) % to_be_received_prol_mg)
            nullify(to_be_levels(i) % to_be_received_flux_mg)
            nullify(to_be_levels(i) % to_be_received_restrict_mg)
          end do
      endif
     ...
     &            'to_be_received is not allocated.'
      ...
      !DEV:  This line was causing a segmentation fault with Absoft compiler.
      !to_be_levels(level) % to_be_received_guard_mg(:,:,:) =  & 
     !&       to_be_received(:,:,:)
!      to_be_levels(level) % to_be_received_guard_mg = to_be_received
      do kTmp = lbound(to_be_received,3), ubound(to_be_received,3)
         do jTmp = lbound(to_be_received,2), ubound(to_be_received,2)
            do iTmp = lbound(to_be_received,1), ubound(to_be_received,1)
               to_be_levels(level) % to_be_received_guard_mg(iTmp,jTmp,kTmp) = &
                    to_be_received(iTmp,jTmp,kTmp)
            end do
         end do
      end do
...
!!!
     ...
     !&        to_be_sent(:,:,:)
      !to_be_levels(level) % to_be_sent_guard_mg =  to_be_sent

      do kTmp = lbound(to_be_sent,3), ubound(to_be_sent,3)
         do jTmp = lbound(to_be_sent,2), ubound(to_be_sent,2)
            do iTmp = lbound(to_be_sent,1), ubound(to_be_sent,1)
               to_be_levels(level) % to_be_sent_guard_mg(iTmp,jTmp,kTmp) = &
                    to_be_sent(iTmp,jTmp,kTmp)
            end do
         end do
      end do
...
!!!
     ...
     !&       to_be_received(:,:,:)
      ...
      do kTmp = lbound(to_be_received,3), ubound(to_be_received,3)
         do jTmp = lbound(to_be_received,2), ubound(to_be_received,2)
            do iTmp = lbound(to_be_received,1), ubound(to_be_received,1)
               to_be_levels(level) % to_be_received_prol_mg(iTmp,jTmp,kTmp) = &
                    to_be_received(iTmp,jTmp,kTmp)
            end do
         end do
      end do
...
!!!
     ...
     !&        to_be_sent(:,:,:)
      do kTmp = lbound(to_be_sent,3), ubound(to_be_sent,3)
         do jTmp = lbound(to_be_sent,2), ubound(to_be_sent,2)
            do iTmp = lbound(to_be_sent,1), ubound(to_be_sent,1)
               to_be_levels(level) % to_be_sent_prol_mg(iTmp,jTmp,kTmp) = &
                    to_be_sent(iTmp,jTmp,kTmp)
            end do
         end do
      end do
...
!!!
     ...
     !&       to_be_received(:,:,:)
      do kTmp = lbound(to_be_received,3), ubound(to_be_received,3)
         do jTmp = lbound(to_be_received,2), ubound(to_be_received,2)
            do iTmp = lbound(to_be_received,1), ubound(to_be_received,1)
               to_be_levels(level) % to_be_received_flux_mg(iTmp,jTmp,kTmp) = &
                    to_be_received(iTmp,jTmp,kTmp)
            end do
         end do
      end do
...
!!!
     ...
     !&        to_be_sent(:,:,:)
      do kTmp = lbound(to_be_sent,3), ubound(to_be_sent,3)
         do jTmp = lbound(to_be_sent,2), ubound(to_be_sent,2)
            do iTmp = lbound(to_be_sent,1), ubound(to_be_sent,1)
               to_be_levels(level) % to_be_sent_flux_mg(iTmp,jTmp,kTmp) = &
                    to_be_sent(iTmp,jTmp,kTmp)
            end do
         end do
      end do
...
!!!
     ...
     !&       to_be_received(:,:,:)
      do kTmp = lbound(to_be_received,3), ubound(to_be_received,3)
         do jTmp = lbound(to_be_received,2), ubound(to_be_received,2)
            do iTmp = lbound(to_be_received,1), ubound(to_be_received,1)
               to_be_levels(level) % to_be_received_restrict_mg(iTmp,jTmp,kTmp) = &
                    to_be_received(iTmp,jTmp,kTmp)
            end do
         end do
      end do
...
!!!
     ...
     !&        to_be_sent(:,:,:)
      do kTmp = lbound(to_be_sent,3), ubound(to_be_sent,3)
         do jTmp = lbound(to_be_sent,2), ubound(to_be_sent,2)
            do iTmp = lbound(to_be_sent,1), ubound(to_be_sent,1)
               to_be_levels(level) % to_be_sent_restrict_mg(iTmp,jTmp,kTmp) = &
                    to_be_sent(iTmp,jTmp,kTmp)
            end do
         end do
      end do
