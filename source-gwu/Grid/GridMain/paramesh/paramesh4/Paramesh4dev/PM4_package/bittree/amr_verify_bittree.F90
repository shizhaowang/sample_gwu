...
#include "Flash_mpi.h"
  ...
  do b=1, lnblocks
    ...
    ! Shizhao, debug
    write(2900000+proc0,*) 'lnblocks,b',lnblocks, b
    write(2900000+proc0,*) 'coord',coord(1:2,b)
    write(2900000+proc0,*) 'bound',grid_xmin, grid_ymin
    write(2900000+proc0,*) 'bsize',bsize(1:2,b)
    write(2900000+proc0,*) 'real lcoord',(coord(1,b)-grid_xmin)/bsize(1,b), (coord(2,b)-grid_ymin)/bsize(2,b)
    write(2900000+proc0,*) 'lcoord',lcoord(1:2)
    write(2900000+proc0,*) 'lrefine,lev',lrefine(b), lev
    write(2900000+proc0,*) ' actual/bittree: proc:',proc0,proc1,'locb:',b,locb 
    write(2900000+proc0,*) ' actual/bittree: locb:',b,locb 
    write(2900000+proc0,*) 
    write(2900000+proc0,*)  '============================'
  ...
  call MPI_barrier(amr_mpi_meshComm, ierr)  ! Shizhao, debug
