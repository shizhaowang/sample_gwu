...
!---------Reset default index ranges
          ...
          if (surrblks(1,2,jj,2)<0) then
             ip4 = 0
          else
             ip4 = mod(ii/2,2)
             ip2 = 0
          end if
          if (surrblks(1,ii,2,2)<0) then
             jp4 = 0
          else
             jp4 = mod(jj/2,2)
             jp2 = 0
...
!-----Loop over the 8 corners
      ...
      Do ii = 1,3,2
        ...
        if (surrblks(1,2,jj,kk)<0) then
           ip4 = 0
        else
           ip4 = mod(ii/2,2)
           ip2 = 0
        end if
        if (surrblks(1,ii,2,kk)<0) then
           jp4 = 0
        else
           jp4 = mod(jj/2,2)
           jp2 = 0
        end if
        if (surrblks(1,ii,jj,2)<0) then
           kp4 = 0
        else
           kp4 = mod(kk/2,2)
           kp2 = 0
