...
!mlrdbg    
        ...
        real  :: cell_face_coord1_child (il_bnd1:iu_bnd1+1),&
                 ...
                 cell_face_coord3_child (kl_bnd1:ku_bnd1+1)
        ...
        kloopC1: do k=kcl,kcu+k3d
         jloopC1: do j=jcl,jcu+k2d
          iloopC1: do i=icl,icu+1
             ...
             if (ndim == 3) dz = cell_face_coord3_parent(k1+k3d)-cell_face_coord3_parent(k1)
