...
! DEFINE BLOCK INTERIOR 
     ...
     &           ierr)
         ...
         istart =  nguard-1
         jstart = (nguard-2)*k2d+1
         kstart = (nguard-2)*k3d+1
         iend   =  nguard+nxb+2
         jend   = (nguard+2)*k2d+nyb
         kend   = (nguard+2)*k3d+nzb
      else
         call MPI_TYPE_VECTOR (nyb+4, & 
     &        (nxb+4), & 
     &        iuw, & 
     ...
     &           ierr)
         ...
         jstart = (nguard_work-2)*k2d+1
         kstart = (nguard_work-2)*k3d+1
         iend   =  nguard_work+nxb+2
         jend   = (nguard_work+2)*k2d+nyb
         kend   = (nguard_work+2)*k3d+nzb
      end if
