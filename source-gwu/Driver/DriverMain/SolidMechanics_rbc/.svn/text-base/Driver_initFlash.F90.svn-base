!!****if* source/Driver/DriverMain/INSfracstep/Driver_initFlash
!!
!! NAME
!!  Driver_initFlash
!!
...
#include "Flash.h"
  ...
  if(dr_globalMe==MASTER_PE)print*,'Incmp_Navier_Stokes initialized'
 
  ! ImBound init
  call ImBound_init(dr_restart)
  if(dr_globalMe==MASTER_PE)print*,'Immersed_Boundaries initialized'
