...
!  write(20000000+dr_globalMe,*) 'meshComm', dr_meshComm
!  write(20000000+dr_globalMe,*) 'meshAcrossComm', dr_meshAcrossComm
!  write(20000000+dr_globalMe,*) 'axisComm', dr_axisComm
!  write(20000000+dr_globalMe,*) 'WoRLD', MPI_COMM_WORLD, FLASH_COMM
