...
!!  "OUT" argument for an overloaded function
  ...
  call RuntimeParameters_get('ibForceIntervalTime',    io_ibForceIntervalTime)
  call RuntimeParameters_get('ibForceIntervalStep',    io_ibForceIntervalStep)
  call RuntimeParameters_get('plotSliceIntervalTime',    io_plotSliceIntervalTime)
  call RuntimeParameters_get('plotSliceIntervalStep',    io_plotSliceIntervalStep)
  call RuntimeParameters_get('plotStatIntervalTime',    io_plotStatIntervalTime)
  call RuntimeParameters_get('plotStatIntervalStep',    io_plotStatIntervalStep)
  call RuntimeParameters_get('StatIntervalTime',    io_StatIntervalTime)
  call RuntimeParameters_get('StatIntervalStep',    io_StatIntervalStep)
  
  call RuntimeParameters_get('init_from_file',    io_init_from_file)
...
!!#endif
  ...
  io_nPlotVars = 0
  do i=1, io_maxPlotVars
     if(any(io_plotVarStr(i) == io_unklabelsGlobal)) io_nPlotVars = io_nPlotVars + 1
