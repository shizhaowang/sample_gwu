...
module IO_data
  ...
  integer, save :: io_ibForceIntervalStep
  integer, save :: io_plotSliceIntervalStep
  integer, save :: io_plotStatIntervalStep
  integer, save :: io_StatIntervalStep

  real, save :: io_checkpointFileIntervalTime
  real, save :: io_plotFileIntervalTime
  real, save :: io_ibForceIntervalTime
  real, save :: io_plotSliceIntervalTime
  real, save :: io_plotStatIntervalTime
  real, save :: io_StatIntervalTime
  ...
  logical, save :: io_doublePrecision
   ...
   logical, save :: io_init_from_file
