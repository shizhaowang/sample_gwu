...
!!$#endif
  ...
  !! Coordinate information --------------------------------------
  !! define a range of coordinates of the rectangle in x-direction
  specs(1) =  -2.0  + 0.005 ! sim_xMin + 0./4.*(sim_xMax - sim_xMin) +.005
  specs(2) =   6.0  - 0.005 !sim_xMax -.005

  !! define a range of coordinates of the rectangle in y-direction
  specs(3) =   0.0  + 0.005 !sim_yMin + 2./4.*(sim_yMax - sim_yMin) +.005
  specs(4) =   4.5  - 0.005 !sim_yMin + 4./4.*(sim_yMax - sim_yMin) -.005

  !! define a range of coordinates of the rectangle in z-direction
  specs(5) =  -1.5  + 0.005 !sim_zMin + 1./4.*(sim_zMax - sim_zMin) +.05
  specs(6) =   1.5  - 0.005 !sim_zMin + 3./4.*(sim_zMax - sim_zMin) -.05
  !! End of coordinate information -------------------------------
  ...
  if (lrefine_min+2 .eq. lrefine_max) return 
