!!****if* source/Simulation/SimulationMain/INavierStokes/3D/EllipseBubble_mcHYPRE/ORIG_Simulation_initBlock
!!
!! NAME
!!
...
!--------KPD------------------------------
!
!    Incomplete, stopped here w/ 2d-->3d
!
!-----------------------------------------
          ...
          !elipdist = ( nx*(x-x1) + ny*(y-y1) + nz*(z-z1) ) &
          !         / sqrt( nx**2 + ny**2 + nz**2 )
          !--------------------------------------------------------------
