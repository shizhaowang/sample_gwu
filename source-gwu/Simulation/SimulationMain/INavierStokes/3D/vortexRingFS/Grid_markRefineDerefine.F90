!!****if* source/Simulation/SimulationMain/INavierStokes/3D/kientzler_bubbleFS_caseA/Grid_markRefineDerefine
!!
!! NAME
...
#define SPECIAL_REFINEMENT 1
  ...
  !!specs(4) =  0. !sim_yMin + 4./4.*(sim_yMax - sim_yMin) -.005
  ...
  !call Grid_markRefineSpecialized (THRESHOLD,specsSize,specs,lref)
