...
!*****************************************************************************************************
      ...
      SUBROUTINE ins_rhs3d_VD(uni,vni,wni,tv,fau,fav,faw,ru1,      &
  ...
  !**************************************************************
      ...
      REAL, DIMENSION(:,:,:), INTENT(IN):: uni, vni, wni, tv, fau, fav, faw, visc, rho1x, rho2x, rho1y, rho2y
             ...
             !=============================================================
               ...
               ru(i,j,k) =                                          &                              
                          ...
                          !- (wxplus*uzplus - wxminus*uzminus)*dz1  &             
                           ...
                           + Mdens*(txzp - txzm)*dz1                &
                           - gravX + fau(i,j,k)*uni(i,j,k) ! Last term - Linear forcing   
             ...
             !=============================================================
               ...
               rv(i,j,k) =                                           &
                          ...
                          !- (wyplus*vzplus - wyminus*vzminus)*dz1   &
                           ...
                           + Mdens* (tyzp - tyzm)*dz1                &
                           - gravY + fav(i,j,k)*vni(i,j,k) ! Last term - Linear forcing
            enddo
         enddo
      enddo
             ...
             !=============================================================
               ...
               rw(i,j,k) =                                          &
                         ...
                         !- (wzplus*wzplus - wzminus*wzminus)*dz1   &
                          ...
                          + Mdens* (tyzp - tyzm)*dy1                &
                          - gravZ + faw(i,j,k)*wni(i,j,k) ! Last term - Linear forcing                   
            enddo
         enddo
      enddo
