...
!  read (9, '(2I8)') NumAelem,NodesPerElem
  ...
  ! Read Files: 
  !open (unit=9, file = 'splashCyl_y0_wCaps.surf', status = 'old', action = 'read')
  !open (unit=9, file = 'splashCyl_y0_wCaps.tri', status = 'old', action = 'read')
  open (unit=9, file = 'splashCyl_y0.surf', status = 'old', action = 'read')
  read (9, '(I8)') NumVertices
