!!****if* source/Simulation/SimulationMain/INavierStokes/3D/IB_sphere/Grid_markRefineDerefine
!!
!! NAME
...
!!$#endif
  ...
  specs(2) =   5.8  - 0.005 !sim_xMax -.005

  !! define a range of coordinates of the rectangle in y-direction
  specs(3) =  -2.1  + 0.005 !sim_yMin + 2./4.*(sim_yMax - sim_yMin) +.005
  specs(4) =   2.1  - 0.005 !sim_yMin + 4./4.*(sim_yMax - sim_yMin) -.005

  !! define a range of coordinates of the rectangle in z-direction
  specs(5) =  -2.1  + 0.005 !sim_zMin + 1./4.*(sim_zMax - sim_zMin) +.05
  specs(6) =   2.1  - 0.005 !sim_zMin + 3./4.*(sim_zMax - sim_zMin) -.05
  !! End of coordinate information -------------------------------
