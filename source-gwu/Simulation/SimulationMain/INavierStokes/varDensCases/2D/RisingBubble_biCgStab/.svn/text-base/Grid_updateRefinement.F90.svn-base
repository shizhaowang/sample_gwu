!!****if* source/Simulation/SimulationMain/INavierStokes/varDensCases/2D/RisingBubble_biCgStab/Grid_updateRefinement
!!
!! NAME
!!
...
!kpd - subroutine Grid_updateRefinement( nstep,time, gridChanged)
subroutine Grid_updateRefinement( nstep,time)
...
#include "Flash.h"
  ...
  real, intent(in) :: time
!kpd-  logical,intent(out),OPTIONAL :: gridChanged
  logical :: gridChanged

  logical :: ins_predcorrflg,ins_outflowgridChanged
