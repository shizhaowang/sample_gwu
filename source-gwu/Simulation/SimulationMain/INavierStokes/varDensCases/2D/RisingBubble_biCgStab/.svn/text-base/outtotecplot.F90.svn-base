...
!  call int2char(mype,index_mype)
  ...
  do lb = 1,blockcount
     ...
     solnData(DUST_VAR,NGUARD,:,1) = solnData(DUST_VAR,NGUARD+1,:,1)
     solnData(DUST_VAR,nxc,:,1)    = solnData(DUST_VAR,nxc-1,:,1)
     solnData(DUST_VAR,:,NGUARD,1) = solnData(DUST_VAR,:,NGUARD+1,1)
     solnData(DUST_VAR,:,nyc,1)    = solnData(DUST_VAR,:,nyc-1,1)
     call centervals2corners(NGUARD,NXB,NYB,nxc,nyc, &
