!!****if* source/Simulation/SimulationMain/INavierStokes/2D/IB_Cyl_parallelIBVP/ImBound_init
!!
!! NAME
!!
!!  ImBound_init
...
!if defined DATAFLG 
  ...
  do b=1,gr_sbNumBodies
     ...
     ! All processors know the xo,yo position for now: we save the data passing in Grid_sbSelectMaster
