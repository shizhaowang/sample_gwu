!!****if* source/Simulation/SimulationMain/INavierStokes/2D/IB_Cyl_parallelIBVP/Grid_markRefineDerefine
!!
!! NAME
...
!!$#endif
  ...
  specs(2) =  12.0 - 0.005 !sim_xMax -.005
  ...
  specs(2) =   7.0 - 0.005 !sim_xMax -.005
  ...
  specs(2) =   4.0 - 0.005 !sim_xMax -.005
  ...
  specs(2) =   1.5  - 0.005 !sim_xMax -.005
