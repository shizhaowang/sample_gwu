!!****if* source/Simulation/SimulationMain/INavierStokes/2D/IB_Cyl_parallelIBVP/Simulation_init
!!
!! NAME
!!
!!  Simulation_init
...
#include "Flash.h"
  ...
  ao = 0.*2.*Ro ! Translational motion amplitude.
