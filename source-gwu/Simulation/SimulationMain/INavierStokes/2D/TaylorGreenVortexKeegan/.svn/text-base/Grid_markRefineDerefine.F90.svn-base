!!****if* source/Simulation/SimulationMain/INavierStokes/2D/TaylorGreenVortexKeegan/Grid_markRefineDerefine
!!
!! NAME
...
!!$  specs(1) =  sim_xMin + 0./8.*(sim_xMax - sim_xMin) +.005
!!$  specs(2) =  sim_xMin + 2./8.*(sim_xMax - sim_xMin) -.005
!!$
!!$  !! define a range of coordinates of the rectangle in y-direction
!!$  specs(3) =  sim_yMin + 6./8.*(sim_yMax - sim_yMin) +.005
!!$  specs(4) =  sim_yMax + 8./8.*(sim_yMax - sim_yMin) -.005
!!$
...
!!$  !! Coordinate information --------------------------------------
!!$  !! define a range of coordinates of the rectangle in x-direction
!!$  specs(1) =  sim_xMin + 6./8.*(sim_xMax - sim_xMin) +.005
!!$  specs(2) =  sim_xMax + 8./8.*(sim_xMax - sim_xMin) -.005
!!$
!!$  !! define a range of coordinates of the rectangle in y-direction
!!$  specs(3) =  sim_yMin + 0./8.*(sim_yMax - sim_yMin) +.005
!!$  specs(4) =  sim_yMin + 2./8.*(sim_yMax - sim_yMin) -.005
!!$
!!$  !! define a range of coordinates of the rectangle in z-direction
!!$  specs(5) =  0. !sim_zMin + 1./4.*(sim_zMax - sim_zMin) +.05
!!$  specs(6) =  0. !sim_zMin + 3./4.*(sim_zMax - sim_zMin) -.05
