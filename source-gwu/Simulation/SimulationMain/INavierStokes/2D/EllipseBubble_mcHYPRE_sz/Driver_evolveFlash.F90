...
subroutine Driver_evolveFlash()
  ...
  use Driver_data, ONLY: dr_globalMe, dr_nbegin,                    &
                         ...
                         dr_restart, dr_elapsedWCTime,dr_meshMe
...
!!$     call Timers_start("Grid_updateRefinement")
     !- kpd - I added this...
if (dr_meshMe .eq. 0) print*,"Did the grid change going into Grid_updateRefinement?",grid_changed
     call Grid_updateRefinement(dr_nstep, dr_simTime)
     !call Grid_updateRefinement(dr_nstep, dr_simTime, grid_changed)
if (dr_meshMe .eq. 0) print*,"Did the grid change coming out Grid_updateRefinement?",grid_changed
