...
! if(gr_meshMe .eq. MASTER_PE) write(*,*) 'Barrier beforce creat virtual  particles'
 ...
 if(gr_meshMe .eq. MASTER_PE) write(*,*) 'Barrier after move particles'
 ...
 call MPI_barrier(MPI_COMM_WORLD,ierr)
 if(gr_meshMe .eq. MASTER_PE) write(*,*) 'Barrier after update particles force'
...
! if(gr_meshMe .eq. MASTER_PE) write(*,*) 'Barrier before allreduce'
! call MPI_barrier(MPI_COMM_WORLD,ierr)
! if(gr_meshMe .eq. MASTER_PE) write(*,*) 'Barrier after allreduce'
