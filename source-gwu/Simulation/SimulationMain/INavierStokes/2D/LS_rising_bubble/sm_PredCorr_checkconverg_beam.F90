...
subroutine sm_PredCorr_checkconverg_beam(testflg,ibd,convflag_pc,errmax_pc)
  ...
  case(SM_SETCONVERGED) ! Case reaches the maximum sub-iteration, Shizhao Wang.
...
end subroutine sm_PredCorr_checkconverg_beam
