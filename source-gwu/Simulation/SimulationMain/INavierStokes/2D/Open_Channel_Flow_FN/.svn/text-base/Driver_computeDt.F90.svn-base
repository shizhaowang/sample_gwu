...
#include "Flash.h"
  ...
  real, intent(INOUT) :: dtOld      !! last time step we used
...
!This is to prevent the code from retaining the smallest time step. (see next
!line) 
 dtOld = 100000

 dtNew = min( dtNew, dtOld*dr_tstepChangeFactor ) !This will retain the smallest
                                                  !time step. No one knows why.
