...
subroutine sm_pk_apply(ibd,time)
  ...
  if (nfix_coord .gt. 0) then 
     ...
     do ircoord = 1,nfix_coord
        ...
        !write(*,*) '======'
        !write(*,*) 'Restrainted DoF', i
        !write(*,*) 'matrix index', idx
        !write(*,*) 'qn(idx)', body%qn(idx)
        !write(*,*) 'qdn(idx)', body%qdn(idx)
        !write(*,*) 'qddn(idx)', body%qddn(idx)
        !write(*,*) '======'
     end do

     !write(*,*) 'qn(1)', body%qn(1)
     !write(*,*) 'qdn(1)', body%qdn(1)
