  ...
  do k=1,blkLimitsGC(HIGH,KAXIS)
     do j=1,blkLimitsGC(HIGH,JAXIS)
        do i=1,blkLimitsGC(HIGH,IAXIS)
          ...
          !solnData(DFUN_VAR,i,j,k) = ycell - 0.02*COS(2.*3.1415926536*xcell)
          !solnData(DFUN_VAR,i,j,k) = ycell - 0.125663706*COS(xcell)
          solnData(DFUN_VAR,i,j,k) = ycell - 0.01*COS(2.*3.1415926536*xcell)
