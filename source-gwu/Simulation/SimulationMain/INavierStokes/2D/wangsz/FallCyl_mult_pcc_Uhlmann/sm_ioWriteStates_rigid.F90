...
#include "constants.h"
  ...
  real, dimension(NDIM) :: force_repul, moment_repul
  ...
  do i = body%ix,body%ex
     ...
     force_repul(i_dim) = body%Rpl(idx)
  end do
  ...
  do i = body%iw,body%ew
     ...
     moment_repul(i_dim) = body%Rpl(idx)
  end do
  ...
  write(113,'(12g18.10)') nstep,time,force_pres(1:NDIM),force_visc(1:NDIM),force_repul(1:NDIM)
  close(113)
  ...
  write(113,'(12g18.10)') nstep,time,moment_pres(1:NDIM),moment_visc(1:NDIM),moment_repul(1:NDIM)
  close(113)
#endif 
