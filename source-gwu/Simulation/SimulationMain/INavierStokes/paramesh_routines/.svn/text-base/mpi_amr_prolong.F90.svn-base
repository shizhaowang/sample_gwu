...
!-----Use statements
      ...
      Use prolong_arrays, Only :                                       & 
           ...
           prol_fc_dbz_n,                                              & 
           prol_fc_clean_divb,                                         &
           prol_fc_divpres, prol_fc_divpres_ivar, prol_fc_divpres_n
...
!-----cell-centered data
     ...
     &          where=gr_cells_INTERIOR, why=gr_callReason_PROLONG)
         ...
         End If                          ! end of iopt if test                      
      End If                             ! end of lcc if test 
...
!--------Do divergence preserving prolongation on some variables 
!--------Variables which correspond to divpres prolongation are
!--------marked on their interp_facei_mask = -200, thet means they will
!--------not be modified by the gen_fun prolongation below.
         if (prol_fc_divpres) Then
...
!!$               write(*,*) 'iv1,iv2,divp=',iv1,iv2
               ...
               (recvfx,recvfy,recvfz,ia,ib,ja,jb,ka,kb,idest,  &
                ioff,joff,koff,mype,iv1,iv2,iv3,lb)
...
!!$          write(*,*) 'In divergence_free=',nfield,lreflevel
