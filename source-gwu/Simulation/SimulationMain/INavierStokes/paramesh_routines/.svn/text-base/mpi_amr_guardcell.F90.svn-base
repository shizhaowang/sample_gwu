...
!-------Copy this blocks data into the working block, and fill its guardcells
        ...
        Do k = 1,1+2*k3d
         ...
         If (k == 1) Then
           ...
           kp1 = 0
           kp2 = 0
           If ((l_force_consist) .or. (neigh(1,5,lb) .le. -20)) kup = k3d
         Else if (k == 2) Then
           klays = nzb*k3d
           kd = nguard0*k3d+1
           kp1 = 0
         ...
         Else if (k == 3) Then
           ...
           kp1 = k3d
           kp2 = k3d
           If ((l_force_consist) .or. (neigh(1,6,lb) .le. -20)) klp = -k3d
         End if
         ku = kd + klays - k3d
        Do j = 1,1+2*k2d
         jlp = 0
         ...
         If (j == 1) Then
           ...
           jp1 = 0
           jp2 = 0
           If ((l_force_consist) .or. (neigh(1,3,lb) .le. -20)) jup = k2d
         Else if (j == 2) Then
           jlays = nyb*k2d
           jd = nguard0*k2d+1
           jp1 = 0
         ...
         Else if (j == 3) Then
           ...
           jp1 = k2d
           jp2 = k2d
           If ((l_force_consist) .or. (neigh(1,4,lb) .le. -20)) jlp = -k2d
         End if
         ju = jd + jlays - k2d
       Do i = 1,3
         ilp = 0
         ...
         If (i == 1) Then
           ...
           ip1 = 0
           ip2 = 0
           If ((l_force_consist) .or. (neigh(1,1,lb) .le. -20)) iup = 1
         Else if (i == 2) Then
           ilays = nxb
           id = nguard0+1
           ip1 = 0
         ...
         Else if (i == 3) Then
           ...
           ip1 = 1
           ip2 = 1
           If ((l_force_consist) .or. (neigh(1,2,lb) .le. -20)) ilp = -1
         Else if (i == 3) Then
         End if
         iu = id + ilays - 1
