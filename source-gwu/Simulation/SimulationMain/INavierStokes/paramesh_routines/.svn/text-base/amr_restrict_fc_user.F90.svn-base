...
!!****if* source/amr_restrict_fc_genorder.F90
!! NAME
...
#include "paramesh_preprocessor.fh"
      ...
      Subroutine amr_restrict_fc_user(recv,temp,icoord,order,ivar)
...
!-----right
      ...
      If (icoord == 1) Then                         ! x-face variables
        ...
        Do i0 = iparmin+2,iparmax-2,2               ! Block boundaries use 1st order face restriction.
        ...
        End Do  ! End Do i0 = iparmin+2,iparmax-2,2
        End Do  ! End Do j0 = jparmin,jparmax,2
        End Do  ! End Do k0 = kparmin,kparmax,2


        ! Here we set Block boundaries to 1st order restriction.
        Do k0 = kparmin,kparmax,2
        Do j0 = jparmin,jparmax,2
        Do i02= 1,2                   ! Block boundaries use 1st order face restriction.

           i0 = iparmin               ! set ipar to iparmin, iparmax
           if (i02 > 1)  i0 = iparmax
           ...
           Do kkk = kstart,kend
              ...
              Do jjj = jstart,jend
                 ...
                 If (ndim == 1) Then
                    www = 1.
                 ElseIf (ndim == 2) Then
                    www = weight(orderb,jw,jjj)
                 ElseIf (ndim == 3) Then
                    www = weight(orderb,jw,jjj) * weight(orderb,kw,kkk)
                 End If
        ...
        End Do  ! End Do i0 = iparmin or iparmax
        End Do  ! End Do j0 = jparmin,jparmax,2
        End Do  ! End Do k0 = kparmin,kparmax,2
      ...
      ElseIf (icoord == 2) Then                     ! y-face variables
        ...
        Do k0 = kparmin,kparmax,2
        Do j0 = jparmin+2,jparmax-2,2               ! Block boundaries use 1st order face restriction.  
        ...
        End Do  ! End Do j0 = jparmin+2,jparmax-2,2
        End Do  ! End Do k0 = kparmin,kparmax,2

        ! Here we set Block boundaries to 1st order restriction.
        Do k0 = kparmin,kparmax,2
        Do j02= 1,2               ! Block boundaries use 1st order face restriction.  
        Do i0 = iparmin,iparmax,2

           j0 = jparmin
           if(j02 .gt. 1) j0 = jparmax 
           ...
           Do kkk = kstart,kend
              ...
              Do iii = istart,iend
                 ...
                 If (ndim == 1) Then
                    www = 1.
                 ElseIf (ndim == 2) Then
                    www = weight(orderb,iw,iii)
                 ElseIf (ndim == 3) Then
                    www = weight(orderb,iw,iii) * weight(orderb,kw,kkk)
                 End If
        ...
        End Do  ! End Do i0 = iparmin,iparmax,2
        End Do  ! End Do j0 = jparmin or jparmax
        End Do  ! End Do k0 = kparmin,kparmax,2
      ...
      ElseIf (icoord == 3) Then                     ! z-face variables
        ...
        Do k0 = kparmin+2,kparmax-2,2               ! Block boundaries use 1st order face restriction.  
        Do j0 = jparmin,jparmax,2
        Do i0 = iparmin,iparmax,2
        ...
        End Do  ! End Do i0 = iparmin,iparmax,2
        End Do  ! End Do j0 = jparmin,jparmax,2
        End Do  ! End Do k0 = kparmin+2,kparmax-2,2

        ! Here we set Block boundaries to 1st order restriction.
        Do k02= 1,2                             ! Block boundaries use 1st order face restriction.  
        Do j0 = jparmin,jparmax,2
        Do i0 = iparmin,iparmax,2
           
           k0 = kparmin
           if(k02 .gt. 1) k0 = kparmax
           ...
           Do jjj = jstart,jend
              ...
              Do iii = istart,iend
                 ...
                 www = weight(orderb,iw,iii) * weight(orderb,jw,jjj)
        ...
        End Do  ! End Do i0 = iparmin,iparmax,2
        End Do  ! End Do j0 = jparmin,jparmax,2
        End Do  ! End Do k0 = kparmin or kparmax
