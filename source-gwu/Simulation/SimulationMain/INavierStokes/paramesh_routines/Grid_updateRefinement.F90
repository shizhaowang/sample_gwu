!!****if* source/Simulation/SimulationMain/INavierStokes/paramesh_routines/Grid_updateRefinement
!!
!! NAME
!!
...
!     if(gr_meshMe == 0) write(*,*) 'update refinement 1', grid_changed, nstep
...
!     if(gr_meshMe == 0) write(*,*) 'amr_restrict', nstep

!     write(*,*) 'update refinement 2', grid_changed
     call Timers_start("markRefineDerefine")
     call Grid_markRefineDerefine()
     call Timers_stop("markRefineDerefine")
     
!     if(gr_meshMe == 0) write(*,*) 'markRefineDerefine', nstep

!     write(*,*) 'update refinement 3', grid_changed
...
!     if(gr_meshMe == 0) write(*,*) 'updateRefinement', nstep

!     write(*,*) 'update refinement 4', grid_changed
     !write(*,*) 'Before Guardcell fill in updateref'

     ! apply BC and fill guardcells for turbulent viscosity
     
     !ins_outflowgridChanged = gridChanged  ! Shizhao removed this line
...
!     if(gr_meshMe == 0) write(*,*) 'fillGuardCells', nstep


  else
     if (present(gridChanged)) gridChanged = .FALSE.
     !ins_outflowgridChanged = gridChanged
     ins_outflowgridChanged = .FALSE.  ! Shizhao, repalce gridChanged with .FALSE.

!     if(gr_meshMe == 0) write(*,*) 'amr_without refinement', nstep
