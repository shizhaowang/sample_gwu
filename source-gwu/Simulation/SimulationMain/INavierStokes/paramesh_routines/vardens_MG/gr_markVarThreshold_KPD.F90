...
!         if (lrefine(b) == lref) then            ! Why ? Just derefine the fineset grid? Shizhao
!          derefine(b) = .true.                        !- kpd - New Derefinement
!         end if
          derefine(b) = .true.    ! Shizhao, new derefinement.
...
!print*,"Searching Grid Ref Criteria in gr_markVarThreshold_KPD.F90"
!-------------------------------------------------------------------------------
