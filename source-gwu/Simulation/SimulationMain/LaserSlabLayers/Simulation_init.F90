!!****if* source/Simulation/SimulationMain/LaserSlabLayers/Simulation_init
!!
!! NAME
!!
!!  Simulation_init
...
#include "Flash.h"
  ...
  call RuntimeParameters_get('sim_coatHeight', sim_coatHeight)
  ...
  call RuntimeParameters_get('sim_rhoCoat', sim_rhoCoat)
  call RuntimeParameters_get('sim_teleCoat', sim_teleCoat)
  call RuntimeParameters_get('sim_tionCoat', sim_tionCoat)
  call RuntimeParameters_get('sim_tradCoat', sim_tradCoat)
