!!****if* source/Simulation/SimulationMain/unitTest/Gravity/BHTree/Grid_markRefineDerefine
!!
!! NAME
...
!!$  force_consistency = .TRUE.
  ...
  ! refine/derefine according to the Jeans criterion
  ! rewrites refine and derefine arrays
  call gr_markJeans()
