!!****if* source/Simulation/SimulationMain/unitTest/SolidBody/MultipleWithTriangles/MovingBodies/NoComm/Bitmap/Grid_getBoundboxCentroids
!!
!! NAME
...
Subroutine Grid_getBoundboxCentroids()
  ...
  do b = 1, gr_sbNumBodies
     gr_sbBodyInfo(b) % boundBox = NONEXISTENT
