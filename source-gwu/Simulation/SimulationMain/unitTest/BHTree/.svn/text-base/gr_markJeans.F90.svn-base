!!****if* source/Simulation/SimulationMain/unitTest/BHTree/gr_markJeans
!!
!! NAME
!!  gr_markJeans
!!
      ...
      do j = blkLimits(LOW, JAXIS), blkLimits(HIGH, JAXIS)
        do i = blkLimits(LOW, IAXIS), blkLimits(HIGH, IAXIS)
          ...
          if (lambda_J2 < del2*jeans_ref**2 ) then
            ...
            derefine(blockList(blockID)) = .false.
          else if (lambda_J2 > del2*jeans_deref**2 .and. (.not. refine(blockList(blockID))) .and. (.not. stay(blockList(blockID)))) then
