!!****if* source/Simulation/SimulationMain/unitTest/PFFT_PoissonParabolae/Grid_unitTest
!!
!! NAME
!!
!!  Grid_unitTest
...
#include "constants.h"
  ...
  use gr_pfftData
#endif PFFT_WITH_MULTIGRID
#endif FLASH_GRID_PARAMESH
...
#include "Flash_mpi.h"
  ...
  do lb = 1,blkCount
     ...
     ! L2 norm of error:
     L2_err = L2_err + sum( vcell**2. *solnData(DIFF_VAR,blkLimits(LOW,IAXIS):blkLimits(HIGH,IAXIS),           &
          blkLimits(LOW,JAXIS):blkLimits(HIGH,JAXIS),           & 
