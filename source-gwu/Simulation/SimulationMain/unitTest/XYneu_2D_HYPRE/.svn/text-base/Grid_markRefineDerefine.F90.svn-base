!!****if* source/Simulation/SimulationMain/unitTest/XYneu_2D_HYPRE/Grid_markRefineDerefine
!!
!! NAME
...
#include "Flash.h"
  ...
  use Grid_data, ONLY : gr_meshMe,gr_refine_cutoff, gr_derefine_cutoff,&
                        gr_refine_filter,&
...
# define SPECIAL_REFINEMENT 1 
  ...
  if (gr_meshMe .eq. 0) write(*,*) 'Specs=',specs(1:7)
