!!****if* source/Simulation/SimulationMain/unitTest/BiCG_XYdir_2D/Simulation_initBlock
!!
!! NAME
!!
  ...
  do k = blkLimits(LOW,KAXIS), blkLimits(HIGH,KAXIS)
     do j = blkLimits(LOW,JAXIS), blkLimits(HIGH,JAXIS)
        do i = blkLimits(LOW,IAXIS), blkLimits(HIGH,IAXIS)
           ...
           solnData(VPHI_VAR,i,j,k) = 0.5*sin(8.*PI*xi*pfb_waven_x/Lx + pfb_alpha_x) * &
                                          sin(8.*PI*yi*pfb_waven_y/Ly + pfb_alpha_y) 
