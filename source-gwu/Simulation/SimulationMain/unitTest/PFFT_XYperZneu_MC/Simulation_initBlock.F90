!!****if* source/Simulation/SimulationMain/unitTest/PFFT_XYperZneu_MC/Simulation_initBlock
!!
!! NAME
!!
...
!                     cos(2.*PI*zi*pfb_waven_z/Lz)
           ...
           F_ijk  = -4.*PI**2 * ( (pfb_waven_x/Lx)**2. + (pfb_waven_y/Ly)**2. + (pfb_waven_z/Lz)**2. ) * Phi_ijk !+ (pfb_waven_z/Lz)**2.


!!$           Phi_ijk = cos(2.*PI*yi*pfb_waven_y/Ly + pfb_alpha_y) * &
!!$                     cos(2.*PI*zi*pfb_waven_z/Lz)
!!$           
!!$           F_ijk  = -4.*PI**2 * ( (pfb_waven_y/Ly)**2. + (pfb_waven_z/Lz)**2. ) * Phi_ijk
