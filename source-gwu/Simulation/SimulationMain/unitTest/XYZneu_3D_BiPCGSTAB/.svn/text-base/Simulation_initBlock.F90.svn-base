!!****if* source/Simulation/SimulationMain/unitTest/XYZneu_3D_BiPCGSTAB/Simulation_initBlock
!!
!! NAME
!!
  ...
  do k = blkLimits(LOW,KAXIS), blkLimits(HIGH,KAXIS)
     do j = blkLimits(LOW,JAXIS), blkLimits(HIGH,JAXIS)
        do i = blkLimits(LOW,IAXIS), blkLimits(HIGH,IAXIS)
           ...
           Phi_ijk = cos(2.*PI*xi*pfb_waven_x/Lx) * &  ! + pfb_alpha_x NO PHASE, X DIRICHLET
