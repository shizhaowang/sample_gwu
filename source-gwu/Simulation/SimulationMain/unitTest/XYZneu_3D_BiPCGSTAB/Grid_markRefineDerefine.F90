!!****if* source/Simulation/SimulationMain/unitTest/XYZneu_3D_BiPCGSTAB/Grid_markRefineDerefine
!!
!! NAME
...
#define SPECIAL_REFINEMENT 1
  ...
  !if (MyPE .eq. 0) write(*,*) 'Specs=',specs(1:7)
  ...
  !! Coordinate information --------------------------------------
  !! define a range of coordinates of the rectangle in x-direction
  specs(1) =  sim_xMin + 3./9.*(sim_xMax - sim_xMin) +.0005
  specs(2) =  sim_xMin + 6./9.*(sim_xMax - sim_xMin) -.0005

  !! define a range of coordinates of the rectangle in y-direction
  specs(3) =  sim_yMin + 3./9.*(sim_yMax - sim_yMin) +.0005
  specs(4) =  sim_yMin + 6./9.*(sim_yMax - sim_yMin) -.0005

  !! define a range of coordinates of the rectangle in z-direction
  specs(5) =  sim_zMin + 1./4.*(sim_zMax - sim_zMin) +.0005
  specs(6) =  sim_zMin + 3./4.*(sim_zMax - sim_zMin) -.0005
  !! End of coordinate information -------------------------------
