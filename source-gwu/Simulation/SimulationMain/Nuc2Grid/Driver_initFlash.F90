!!****if* source/Simulation/SimulationMain/Nuc2Grid/Driver_initFlash
!!
!! NAME
!!  Driver_initFlash
!!
...
#include "Flash.h"
  ...
  ! As far as particles initialization is concerned, we are
  ! pretending NOT to restart - even if, as far as Grid is
  ! concerned, we are!
  call Particles_initData(restart=.FALSE.,partPosInitialized=dr_particlesInitialized)
