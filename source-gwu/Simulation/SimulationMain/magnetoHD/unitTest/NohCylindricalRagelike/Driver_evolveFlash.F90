...
#include "constants.h"
#include "Flash.h"
!#include "Noh_unitTest.F90"
!#include "Flash_mpi.h"
  logical :: checked_Density = .false.,perfect = .true.
  ...
  do dr_nstep = dr_nBegin, dr_nend
     ...
     !Instead of exiting, this step has been hacked to run a Chi Square test
     !for goodness of fit of the densities to expected values
     if(shortenedDt) then
           call Noh_compareDensity(dr_simTime,checked_Density)
     endif
