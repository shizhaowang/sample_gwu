!!****if* source/Simulation/SimulationMain/magnetoHD/KHS/Simulation_init
!!
!! NAME
!!
!!  Simulation_init
...
!!  Initializes initial conditions for the spatially varying
!!  KH instability problem.
!!
!!***
...
subroutine Simulation_init()
  ...
  use Simulation_data, ONLY : sim_gamma, sim_xMin, sim_yMin, sim_zMin, &
                              ...
                              sim_Bz0, sim_epsilon, sim_shearThick,sim_dVx0,&
                              sim_perturb, sim_smallP, sim_smallX,     &
                              sim_meshMe
...
#include "Flash.h"
  ...
  call RuntimeParameters_get('ShearThick',sim_shearThick)
  call RuntimeParameters_get('dVx0',sim_dVx0)
  call RuntimeParameters_get('perturbBoundary',sim_perturb)
