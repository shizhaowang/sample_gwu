!!****if* source/Simulation/SimulationMain/magnetoHD/BierSedov/Simulation_data
!!
!! NAME
!!
!!  Simulation_data
...
#include "constants.h"
  ...
  integer, save :: sim_vortSlopeLimit
  integer, parameter :: VORTSL_NONE    = 0
  integer, parameter :: VORTSL_VANLEER = 1
  integer, parameter :: VORTSL_MINMOD  = 2
  integer, parameter :: VORTSL_MC      = 3
