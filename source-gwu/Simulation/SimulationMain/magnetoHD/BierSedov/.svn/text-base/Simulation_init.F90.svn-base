!!****if* source/Simulation/SimulationMain/magnetoHD/BierSedov/Simulation_init
!!
!! NAME
!!
!!  Simulation_init
...
#endif
  call RuntimeParameters_get('sim_vortSlopeLimit', str)
  select case (trim(str))
  case ("none")
     sim_vortSlopeLimit = VORTSL_NONE
  case ("vanLeer")
     sim_vortSlopeLimit = VORTSL_VANLEER
  case ("minmod")
     sim_vortSlopeLimit = VORTSL_MINMOD
  case ("mc")
     sim_vortSlopeLimit = VORTSL_MC
  end select
