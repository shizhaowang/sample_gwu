!!****if* source/Simulation/SimulationMain/magnetoHD/BierSedov/Simulation_initBlock
!!
!! NAME
!!
...
#include "Flash.h"
  ...
  real, dimension(:,:,:,:),pointer :: solnData,Bx,By
...
#ifdef FLASH_3T
           call Grid_putPointData(blockId, CENTER, EELE_VAR, EXTERIOR, axis, sim_singleSpeciesZ * e / (sim_singleSpeciesZ + 1) )    
           call Grid_putPointData(blockId, CENTER, EION_VAR, EXTERIOR, axis, e / (sim_singleSpeciesZ + 1) )    
           call Grid_putPointData(blockId, CENTER, ERAD_VAR, EXTERIOR, axis, e*1.0e-14)    
#endif
