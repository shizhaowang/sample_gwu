!!****if* source/Simulation/SimulationMain/magnetoHD/AdvectBall/Simulation_init
!!
!! NAME
!!
!!  Simulation_init
...
#include "Flash.h"
  ...
  call RuntimeParameters_get('Ux_initial',   sim_Ux_initial)
  call RuntimeParameters_get('Uy_initial',   sim_Uy_initial)
  call RuntimeParameters_get('Uz_initial',   sim_Uz_initial)

  call RuntimeParameters_get('ballRadius', sim_ballRadius)
