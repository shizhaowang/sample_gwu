!!****if* source/Simulation/SimulationMain/Sod_Se_Advect/Driver_evolveFlash
!!
!! NAME
!!
!!  Driver_evolveFlash
...
!!******************************************************************************
  ...
  do dr_nstep = dr_nbegin, dr_nend
     ...
     call Timers_start("cosmology")
     call Cosmology_redshiftHydro(dr_globalMe, dr_numprocs, blockCount, blockList)
     call Timers_stop("cosmology")
...
!!******************************************************************************
  ...
  print*,'Dumping component temperatures to text file'
  do lb = 1, blockCount
     call Grid_dump((/TION_VAR,TELE_VAR/),2,blockList(lb),gcell=.FALSE.)
  end do
  ...
  call Timers_getSummary(dr_globalMe, max(0,dr_nstep-dr_nbegin+1))
