!!****if* source/Simulation/SimulationMain/Sod_Se_Advect/Grid_dump
!!
!! NAME
!!  Grid_dump
!!
...
998           format(4(1x,1PG15.4),5(1x,1PG20.10))
              write(FU(IVAR),998) x(i),(unk(var(n),i,j,k,blockID),n=1,num)
           end do
        end do
     end do
