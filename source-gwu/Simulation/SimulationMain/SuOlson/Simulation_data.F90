!!****if* source/Simulation/SimulationMain/SuOlson/Simulation_data
!!
!! NAME
!!  Simulation_data
!!
...
module Simulation_data
  ...
  ! Runtime parameters for Radiation Diffusion.
  real, save :: sim_iniRadDiffExp, sim_raddiffTEx, sim_alphaR, sim_xi0R

  ! Runtime params for Su-Olson type problem.
  real, save :: sim_epsEle, sim_epsIon 
