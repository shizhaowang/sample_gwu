!!****if* source/Simulation/SimulationMain/SamraiTest/Driver_global
!!
!! NAME
!!
!!  Driver_evolveFlash
...
#include "constants.h"
  ...
  filename = "test_UniformGrid"//char(48+prNum(4))//char(48+prNum(3))//&
  ...
  Call Grid_unitTest(dr_globalMe,fileUnit,perfect)
