!!****if* source/Simulation/SimulationMain/RHD_Sod/Simulation_data
!!
!! NAME
!!  Simulation_data
!!
...
module Simulation_data
  ...
  real, save :: sim_uLeft,sim_uRight, sim_vLeft, sim_vRight, sim_wLeft, sim_wRight
  real, save :: sim_xAngle, sim_yAngle, sim_posn
