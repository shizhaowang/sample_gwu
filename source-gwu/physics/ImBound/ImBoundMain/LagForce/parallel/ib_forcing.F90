...
#include "ImBound.h"
  ...
  do i = 1,NDIM
     ...
     if (force_fl(i)) then
        ...
        !Shizhao, for debugging
        !write(2000000+gr_meshMe*100+ibd,*) part_Pos, particleData(PROC_PART_PROP), particleData(BLK_PART_PROP) 
        !if(abs(part_Pos(1)+0.166219292475285) < 1.0d-12 .and. &
        !   abs(part_Pos(2)+0.676468913432300) < 1.0d-12 .and. &
        !   abs(part_Pos(3)-10.8905004882812)  < 1.0d-12) then
        !  write(*,*) 'particle position:', part_Pos
        !  write(*,*) 'elem:', ib_ielem(:,:,i)
        !  write(*,*) 'bsize:', bsize
        !  write(*,*) 'coord:', coord
        !  write(*,*) 'low bound:', coord - bsize/2.0
        !  write(*,*) 'Master and block:', particleData(PROC_PART_PROP), particleData(BLK_PART_PROP) 
        !endif
...
!  endif
!  write(33,*) ibd
!  write(33,'(6f20.12)') part_Pos(1:NDIM),ib_uL(1:NDIM),ib_FuL(1:NDIM)
!  close(33)
