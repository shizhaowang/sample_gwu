...
!  call Logfile_stamp( 'Entering Forcing' , '[ImBound]')
  ...
  call Timers_start('gr_createSendLagP')
  ! Flush Particles.
!  call Timers_start('gr_sbFinalize')
  call gr_sbFinalize()
!  call Timers_stop('gr_sbFinalize')
...
!  call Timers_stop("gr_sbSendPosn")
  call Timers_stop('gr_createSendLagP')

! Shizhao 

  call Timers_start('gr_IBForce')
  !call gr_sbUpdateForces_Lag()
  call gr_sbUpdateForces()
  call Timers_stop('gr_IBForce')
