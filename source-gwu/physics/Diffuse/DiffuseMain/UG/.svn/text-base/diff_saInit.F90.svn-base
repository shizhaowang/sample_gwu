!!****if* source/physics/Diffuse/DiffuseMain/UG/diff_saInit
!!
!! NAME
!!
!!  diff_saInit
...
#include "constants.h"
  ...
  ! Rad Diffusion
  call RuntimeParameters_get("diff_radXlBoundaryType", xl_bcString)
  call RuntimeParameters_get("diff_radXrBoundaryType", xr_bcString)
  call RuntimeParameters_get("diff_radYlBoundaryType", yl_bcString)
  call RuntimeParameters_get("diff_radYrBoundaryType", yr_bcString)
  call RuntimeParameters_get("diff_radZlBoundaryType", zl_bcString)
  call RuntimeParameters_get("diff_radZrBoundaryType", zr_bcString)

  call RuntimeParameters_mapStrToInt(xl_bcString,diff_radDomainBC(1))
  call RuntimeParameters_mapStrToInt(xr_bcString,diff_radDomainBC(2))
  call RuntimeParameters_mapStrToInt(yl_bcString,diff_radDomainBC(3))
  call RuntimeParameters_mapStrToInt(yr_bcString,diff_radDomainBC(4))
  call RuntimeParameters_mapStrToInt(zl_bcString,diff_radDomainBC(5))
  call RuntimeParameters_mapStrToInt(zr_bcString,diff_radDomainBC(6))

  !! setup the HYPRE diffusion solver.
  call diff_setupHypreSolver()
