!!****if* source/physics/IncompNS/IncompNSMain/constdens/ins_rescaleVelout
!!
!!
!! NAME
!!
...
!=============================================================================
  ...
  Qindout = 1.
  if (abs(Qout) .gt. eps*abs(Qin)) Qindout = Qin/Qout

  if(ins_meshMe .eq. MASTER_PE) write(*,*) 'Qin, Qout, Qin/Qout=',Qin,Qout,Qindout
