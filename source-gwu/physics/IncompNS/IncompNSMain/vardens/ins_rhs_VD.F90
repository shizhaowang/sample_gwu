          ...
          do i = ix1,ix2+1
             ...
             ru(i,j,kz1) =                                          &
                         ...
                         !- vdudy                                   & 
                          ...
                          + Mdens*(tyyp - tyym)*dy1                 &
                          + gravX      ! Shizhao changed the sign to keep consistence with the gravity of the solid body      
                          !- gravX     
             !!ru(i,j,kz1) = 0.0 
          enddo
       enddo
          ...
          do i = ix1,ix2
             ...
             rv(i,j,kz1) =                                           &
                         ...
                         !- vdvdy                                    & 
                          ...
                          + Mdens* (txxp - txxm)*dx1                 &! diffusion - normal terms
                          + Mdens* (tyyp - tyym)*dy1                 &
                          + gravY      ! Shizhao changed the sign to keep consistence with the gravity of the solid body      
             ...
             !=============================================================
               ...
               rw(i,j,k) =                                          &
                         ...
                         !- (wzplus*wzplus - wzminus*wzminus)*dz1   &
                          ...
                          + Mdens* (tyzp - tyzm)*dy1                &
                          + gravZ      ! Shizhao changed the sign to keep consistence with the gravity of the solid body      
                          !- gravZ                   
            enddo
         enddo
      enddo
