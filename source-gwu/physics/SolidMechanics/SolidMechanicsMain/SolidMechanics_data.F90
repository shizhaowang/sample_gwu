...
type sm_structure
   ...
   ! Repulsive force model, Shizhao Wang, Nov 2014
   real, allocatable, dimension(:) :: Rpl
...
! Particle positions, Shizhao Wang, for repulsive model in particle laden flows,
! Nov 2914
real, save, allocatable, dimension(:,:) :: sm_pos

! Parameters for collipse model
real, save :: sm_cm_rhou, sm_cm_eps1, sm_cm_eps2

! The character length of the solid body
! To test the relation between particle point and body center for periodic BCs
real, save :: sm_CL = 10000000.0 !0.51  ! for the circular cylinder and sphere  case, a little larger than the radius
