...
&'Particle types other than PASSIVE are included in the configuration, therefore ignoring reduceGcellFills for Particles_advance!'&
  ...
  !! to the attributes of the various types of entities (particels Vs rays for example)
  ...
  call Driver_abortFlash("Particles_init: two types of temporary position attributes are not supported yet (TMPX_PART_PROP / POSPREDX_PART_PROP)")
#endif
